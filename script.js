...
$(document).ready(function () {
  var entries = [
    ...
    { label: "NodeJS", url: "https://nodejs.org/en/", target: "_top" },
    {
      label: "Python",
    ...
    { label: "CSS", url: "https://vi.wikipedia.org/wiki/CSS", target: "_top" },
    {
      label: "JSFiddle",
      url: "https://jsfiddle.net/user/tan040499/fiddles/",
      target: "_top",
    },
    { label: "CodePen", url: "https://codepen.io/vdt040499", target: "_top" },
    { label: "Git", url: "https://git-scm.com/", target: "_top" },
    { label: "GitHub", url: "https://github.com/vdt040499", target: "_top" },
    { label: "Bootstrap", url: "https://getbootstrap.com/", target: "_top" },
    { label: "Express", url: "https://expressjs.com/", target: "_top" },
    { label: "ReactJS", url: "https://reactjs.org/", target: "_top" },
    {
      label: "MongoDB",
